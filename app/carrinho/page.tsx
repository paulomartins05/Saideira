...
import { TicketSkeleton } from "../_components/skeletons";

async function ListaResgates({ userId }: { userId: string }) {
    ...
    if (meusResgates.length === 0) {
        return (
            <div className="bg-card border border-line p-10 rounded-[20px] text-center flex flex-col items-center justify-center">
                ...
                <h2 className="text-lg font-bold mb-2">Sem resgates pendentes</h2>
                <p className="text-sm text-muted mb-6">Você ainda não reservou nenhum produto recentemente.</p>
            ...
            <main className="pb-10">
                <div className="max-w-[800px] mx-auto px-7 pt-7">
                    ...
                    <Suspense fallback={
                        ...
                        <ListaResgates userId={session.user.id} />
                    </Suspense>
