  ...
  return (
    <section className="bg-gradient-to-b from-night to-[#20242E] text-paper pt-9 px-7 pb-10">
      <div className="max-w-[640px] mx-auto text-center md:text-left flex flex-col md:items-start items-center">
        ...
        {/* Barra de Busca */}
        <div className="flex items-stretch bg-card rounded-xl overflow-hidden shadow-[0_12px_28px_-10px_rgba(0,0,0,0.4)] w-full max-w-[500px]">
          ...
          />
          <button className="bg-amber text-night font-bold text-[13px] px-5 shrink-0 hover:bg-amber-dark transition-colors">
            Buscar
          </button>
        </div>
